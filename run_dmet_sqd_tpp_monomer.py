...
options = {
    ...
    "optimizer": lambda func, mu0: noisy_optimizer(dmet, mu0, noisy_optimizer_options),
    "verbose": True,
}
...
print(f"Converged DMET chemical potential: {dmet.chemical_potential:.10f}")
print(f"Final DMET electron residual: {dmet.electron_residual:.10f}")
